...
# res = {}
# for name, base, prem in zip (names, salary, bonus):
#     res[name] = (base * float(prem[:-1])/100)
# print(res)

result = {name: (base * float(prem[:-1])/100) for name, base, prem in zip (names, salary, bonus)}
print(result)
