...
#
# check_multiplicity(amount): Проверка кратности суммы при
# пополнении и снятии.
# deposit(amount): Пополнение счёта.
# withdraw(amount): Снятие денег.
# exit(): Завершение работы и вывод итоговой информации о
# состоянии счета и проведенных операциях.
#
# Пополнение счета:
...
# print(operations)
# На выходе:
# ['Пополнение карты на 1000 у.е. Итого 1000 у.е.', 'Снятие с карты
# 200 у.е. Процент за снятие 30 у.е.. Итого 770 у.е.',
...
# 'Снятие с карты 200 у.е. Процент за снятие 30 у.е.. Итого 999999999999770
# у.е.', 'Снятие с карты 300 у.е. Процент за снятие 30 у.е..
# Итого 999999999999440 у.е.', 'Пополнение карты на 500 у.е.
# Итого 999999999999940 у.е.', 'Снятие с карты 3000 у.е.
# Процент за снятие 45.000 у.е.. Итого 999999999996895.000 у.е.',
# 'Вычтен налог на богатство 0.1% в сумме 99999999999689.5000 у.е.
# Итого 899999999997205.5000 у.е.', 'Возьмите карту на которой
# 899999999997205.5000 у.е.']
...
# аргументов и вызовет функцию для проверки
